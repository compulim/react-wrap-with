...
// export declare function describeEach<T0, T1, T2, T3, T4, T5, T6, T7>(
...
// export declare function describeEach<T0, T1, T2, T3, T4, T5, T6, T7, T8>(
